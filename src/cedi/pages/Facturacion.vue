<template>
    <Layout>
        ...
        <div class="" v-if="activeTabName === tabNames.tab1">
            <ListaFacturas :data="data" :loading="loading" :url="url" :getData="getData"/>
        </div>

        <div class="" v-if="activeTabName === tabNames.tab2">
            <CrearFactura :getData="getData" :url="url" :tab="handleTabClick" :nameTab="tabNames.tab1"/>
        </div>
...
<script>
    ...
    import ListaFacturas from '@/cedi/components/facturacion/ListaFacturas';
    import CrearFactura from '@/cedi/components/facturacion/CrearFactura';
