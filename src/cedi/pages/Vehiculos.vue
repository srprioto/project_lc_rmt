<template>
    <Layout>
        ...
        <div class="" v-if="activeTabName === tabNames.tab1">
            <ListaVehiculos :data="data" :loading="loading" :url="url" :getData="getData"/>
        </div>

        <div class="" v-if="activeTabName === tabNames.tab2">
            <CrearVehiculo :getData="getData" :url="url" :tab="handleTabClick" :nameTab="tabNames.tab1"/>
        </div>
...
<script>
    ...
    import ListaVehiculos from '@/cedi/components/vehiculos/ListaVehiculos';
    import CrearVehiculo from '@/cedi/components/vehiculos/CrearVehiculo';
    ...
    export default {
        ...
        data() {
            return {
                activeTabName: 'Lista vehiculos',
                tabNames: {
                    tab1: 'Lista vehiculos',
                    tab2: 'Crear vehiculo'
                },

                url: dominio() + "vehicles",
                data: {},
                loading: true,
                error: null,
